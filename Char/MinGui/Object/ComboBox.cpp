...
void MinGui::ComboBox(const std::vector<std::string>& items, const Vec2& size, int& value, std::string desc)
{
	...
	Render::AddText(DrawPos + Vec2{ size.x - 10, size.y / 2 }, "+", global_colors.color_text, AlignMode::CENTER, Ctx.CurLevel + 2);
...
void MinGui::MultiComboBox(std::vector<MultiItem> items, const Vec2& size, std::string desc)
{
